...
The (0, 0) origin will be in the upper-left corner, the
 x-coordinates increase going right, and w the y-coordinates increase going down.
...
Then your program should print grid[0][1]
, then grid[1][1]
, then grid[2][1]
...
# TODO: make algorithm for printing the shape.

# TODO: make algorithm for printing the shape in the right angle.